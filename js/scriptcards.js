...
const UPDATE = (event) => {
  ...
  for (const CARD of CARDS) {
    ...
    if (
      (event === null || event === void 0 ? void 0 : event.x) >
        CARD_BOUNDS.left - CONFIG.proximity &&
      (event === null || event === void 0 ? void 0 : event.x) <
        CARD_BOUNDS.left + CARD_BOUNDS.width + CONFIG.proximity &&
      (event === null || event === void 0 ? void 0 : event.y) >
        CARD_BOUNDS.top - CONFIG.proximity &&
      (event === null || event === void 0 ? void 0 : event.y) <
    ...
    let ANGLE =
      (Math.atan2(
        (event === null || event === void 0 ? void 0 : event.y) -
          CARD_CENTER[1],
        (event === null || event === void 0 ? void 0 : event.x) - CARD_CENTER[0]
      ) *
        180) /
      Math.PI;
